...
<main class="">
	<div class="text-center">
		<div class="my-16">
			<h1 class="text-4xl md:text-7xl font-black mb-4 animate-in fade-in slide-in-from-left-12 duration-700">Sign Up</h1>
			<h2 class="text-2xl md:text-3xl font-bold text-pink-700 mb-2 transition-all duration-1000 {visible ? 'opacity-100 blur-none' : 'opacity-0 blur-md'}">Create your account below:</h2>
		</div>
		<form 
			method="POST" 
			action="?/signup"
		...
		>
			...
			<div>
				<label for="confirm-password" class="block mb-1 font-semibold text-pink-700">Confirm Password</label>
				<input 
					id="confirm-password" 
			...
			<div class="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-center sm:space-y-0 w-full">
				<div class="text-sm text-center sm:text-left w-full justify-center flex">
					...
					<a href="/signin" class="ml-1 font-medium text-pink-600 hover:text-pink-500">Sign in</a>
				</div>
			</div>
		</form>
	</div>
