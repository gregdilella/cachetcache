...
<main class="">
	<div class="text-center px-4">
		<div class="my-8 sm:my-16">
			...
			<h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-pink-700 mb-2 transition-all duration-1000 {visible ? 'opacity-100 blur-none' : 'opacity-0 blur-md'}">{$t.signupPage.createAccount}</h2>
		</div>
		<form 
			method="POST" 
			action="?/signup"
		...
		>
			...
			<div class="pt-4 border-t border-pink-200">
				<h3 class="text-lg font-semibold text-pink-700 mb-4">Profile Information</h3>
